...
const routes = [
	...
	// 视频分类路由
	{
		path: '/video_classification/table',
		name: 'video_classification_table',
		component: () => import('../views/video_classification/table.vue')
	},
	{
		path: '/video_classification/view',
		name: 'video_classification_view',
		component: () => import('../views/video_classification/view.vue')
	},
	// 精彩视频路由
	{
		path: '/wonderful_video/table',
		name: 'wonderful_video_table',
		component: () => import('../views/wonderful_video/table.vue')
	},
	{
		path: '/wonderful_video/view',
		name: 'wonderful_video_view',
		component: () => import('../views/wonderful_video/view.vue')
	},
