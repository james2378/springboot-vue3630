<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="视频名称">
						<el-input v-model="query.video_name"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="视频类别">
						<el-select v-model="query.video_category">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/wonderful_video/table','add') || $check_action('/wonderful_video/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            <el-button v-if="user_group == '管理员' || $check_action('/wonderful_video/table','del') || $check_action('/wonderful_video/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="video_number" label="视频编号"
				v-if="user_group == '管理员' || $check_field('get','video_number')" min-width="200">
			</el-table-column>
			<el-table-column prop="video_name" label="视频名称"
				v-if="user_group == '管理员' || $check_field('get','video_name')" min-width="200">
			</el-table-column>
			<el-table-column prop="video_category" label="视频类别"
				v-if="user_group == '管理员' || $check_field('get','video_category')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/wonderful_video/table','set') || $check_action('/wonderful_video/view','set') || $check_action('/wonderful_video/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/wonderful_video/table','set') || $check_action('/wonderful_video/view','set') || $check_action('/wonderful_video/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>详情</span>
					</router-link>
					<router-link v-if="user_group == '管理员' || $check_comment('/wonderful_video/table')" class="el-button el-button--small is-plain el-button--primary"
								 :to="'../comment/table?size=10&page=1&source_table=wonderful_video&source_field=' + field + '&source_id=' + scope.row[field]" size="small">
						查看评论
					</router-link>
				</template>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				url_del: "~/api/wonderful_video/del?",
