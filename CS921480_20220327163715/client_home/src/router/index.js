...
const routes = [
	...
	//精彩视频列表路由
	{
		path: '/wonderful_video/list',
		name: '/wonderful_video_list',
		component: () => import('../views/wonderful_video/list.vue')
	},
	//精彩视频详情路由
	{
		path: '/wonderful_video/details',
		name: '/wonderful_video_details',
		component: () => import('../views/wonderful_video/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "在线视频点播系统-home";
	document.title = title;
	document.logo = "在线视频点播系统"
})
